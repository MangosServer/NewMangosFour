...
struct SceneScriptEntry
{
    ...
    uint32 FirstSceneScriptID;                                 // 3         m_prevScriptPartID - Prev Script Part Id From Chain
    uint32 NextSceneScriptID;                                 // 4         m_nextScriptPartID - Next Script Part Id From Chain
};
#endif
