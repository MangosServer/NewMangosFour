...
static void test_six_inbound_fixtures_and_exact_relay()
{
    RefState const state;
    std::array<OpcodesList, 6> const opcodes {{ CMSG_MOVE_START_FORWARD, CMSG_MOVE_START_BACKWARD,
        CMSG_MOVE_STOP, MSG_MOVE_HEARTBEAT, CMSG_MOVE_SET_FACING, CMSG_MOVE_FALL_LAND }};
    std::array<std::vector<uint8>, 6> fixtures;
    MovementInfo infos[6] = {
