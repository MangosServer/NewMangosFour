...
static void test_normal_update()
{
    ...
    CHECK(Equal(packet, {
        ...
        // Dungeon (2) then raid (3), NOT struct declaration order. This pair is byte-identical
        // to capture-000006 seq 1424, which carries 02 00 00 00 03 00 00 00 in exactly this
        // position. The previous expectation was 03 then 02 -- an inverse of the builder rather
        // than an independent fixture, so it certified the transposition instead of catching it.
