...
enum OpcodesList
{
    ...
    SMSG_TIME_SYNC_REQ                           = 0x1A8F,    // 5.4.8 18414 (Wow.exe leaf; name single-source fork)
    ...
    SMSG_RAID_READY_CHECK_CONFIRM                = 0x02AF,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_REALM_NAME_QUERY_RESPONSE               = 0x063E,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_QUEST_PUSH_RESULT                       = 0x074D,    // 5.4.8 18414 (Wow.exe leaf; name fork tables)
    ...
    SMSG_TABARD_VENDOR_ACTIVATE                  = 0x0A3E,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    SMSG_GUILD_RANKS_UPDATE                      = 0x0A60,    // 5.4.8 18414 (Wow.exe leaf; name fork tables)
    ...
    SMSG_GUILD_EVENT_PLAYER_LEFT                 = 0x0BF8,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_UPDATE_CURRENCY                         = 0x129E,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_LFG_BOOT_PROPOSAL_UPDATE                = 0x183A,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE      = 0x1A3A,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_SETUP_CURRENCY                          = 0x1A8B,    // 5.4.8 18414 (Wow.exe leaf; name fork tables, low confidence)
    ...
    SMSG_RAID_READY_CHECK                        = 0x1C8E,    // 5.4.8 18414 (Wow.exe leaf; name fork tables)
