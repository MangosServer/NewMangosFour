...
enum OpcodesList
{
    ...
    SMSG_AUCTION_SOLD_NOTIFICATION               = 0x11C1,    // 5.4.8 18414 (Wow.exe sold leaf and body)
    SMSG_AUCTION_OWNER_NOTIFICATION              = 0x1A8E,    // 5.4.8 18414 (Wow.exe expired/removed leaf and body)
    SMSG_AUCTION_BID_UPDATE_NOTIFICATION         = 0x18AE,    // 5.4.8 18414 (Wow.exe bid-update leaf and body)
    SMSG_AUCTION_WON_NOTIFICATION                = 0x1A9F,    // 5.4.8 18414 (Wow.exe won leaf and body)
