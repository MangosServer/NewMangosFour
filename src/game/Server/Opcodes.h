...
enum OpcodesList
{
    ...
    CMSG_AUTH_SESSION                            = 0x00B2, // 5.4.8 18414 (SkyFire)
    ...
    CMSG_CHAR_CREATE                             = 0x0F1D, // 5.4.8 18414 (SkyFire)
    CMSG_CHAR_ENUM                               = 0x00E0, // 5.4.8 18414 (SkyFire)
    ...
    CMSG_PLAYER_LOGIN                            = 0x158F, // 5.4.8 18414 (SkyFire)
    ...
    CMSG_PING                                    = 0x0012, // 5.4.8 18414 (SkyFire)
    ...
    CMSG_REALM_SPLIT                             = 0x0062, // 5.4.8 18414 (SkyFire)
    ...
    CMSG_KEEP_ALIVE                              = 0x1A87, // 5.4.8 18414 (SkyFire) (was 0x0015)
    ...
    CMSG_LOG_DISCONNECT                          = 0x10B3, // 5.4.8 18414 (SkyFire) (new symbol)
