...
enum OpcodesList
{
    ...
    SMSG_PETGODMODE                              = 0x1940,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_REFER_A_FRIEND_EXPIRED                  = 0x1143,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_GODMODE                                 = 0x1862,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_DEBUG_AISTATE                           = 0x0A2A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire; via SMSG_DEBUG_AI_STATE)
    ...
    SMSG_CHAR_ENUM                               = 0x11C3,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_CHARACTER_LOGIN_FAILED                  = 0x1A0B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_LOGIN_SETTIMESPEED                      = 0x082B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_GAMETIME_UPDATE                         = 0x0E1B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_GAMETIME_SET                            = 0x0A0F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_GAMESPEED_SET                           = 0x1048,    // (value unverified; no client leaf)
    SMSG_SERVERTIME                              = 0x1C3E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_NAME_QUERY_RESPONSE                     = 0x169B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_GROUP_LIST                              = 0x0CBB,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    SMSG_GUILD_DECLINE                           = 0x1AF9,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    CMSG_GUILD_INFO                              = 0x1088, // not in 5.4.8 (legacy)
    SMSG_GUILD_INFO                              = 0x1089,    // (no client leaf)
    ...
    SMSG_GUILD_EVENT                             = 0x0705,    // 4.3.4 15595 (unverified; no client leaf)
    ...
    SMSG_READ_ITEM_FAILED                        = 0x0E8B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire; fuzzy via SMSG_READ_ITEM_RESULT_FAILED)
    ...
    SMSG_MONSTER_MOVE                            = 0x1A07,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_TRIGGER_CINEMATIC                       = 0x0B01,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    SMSG_OPEN_CONTAINER                          = 0x14BB,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_ACTION_BUTTONS                          = 0x081A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_INITIAL_SPELLS                          = 0x045A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_ATTACKSTART                             = 0x1A9E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_ATTACKERSTATEUPDATE                     = 0x06AA,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_BATTLEFIELD_PORT_DENIED                 = 0x149A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_RESUME_CAST_BAR                         = 0x01D2,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_SPELLHEALLOG                            = 0x09FB,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_SPELLENERGIZELOG                        = 0x0D79,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_BREAK_TARGET                            = 0x021A,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_BINDPOINTUPDATE                         = 0x0E3B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_MOUNTRESULT                             = 0x0E0F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_DISMOUNTRESULT                          = 0x062F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_PET_MODE                                = 0x163F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_QUESTUPDATE_ADD_KILL                    = 0x1645,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: WPP; via SMSG_QUEST_UPDATE_ADD_KILL)
    ...
    SMSG_QUEST_CONFIRM_ACCEPT                    = 0x13C7,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    MSG_PETITION_DECLINE                         = 0x4905,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    MSG_MINIMAP_PING                             = 0x6635,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    SMSG_PAUSE_MIRROR_TIMER                      = 0x162E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_GAMEOBJECT_PAGETEXT                     = 0x14AF,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_INVALID_PROMOTION_CODE                  = 0x1A0E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    MSG_GM_BIND_OTHER                            = 0x11E9,    // (no client leaf)
    MSG_GM_SUMMON                                = 0x11EA,    // (no client leaf)
    SMSG_ITEM_TIME_UPDATE                        = 0x18C1,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_ITEM_ENCHANT_TIME_UPDATE                = 0x10A2,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    SMSG_LFG_TELEPORT_DENIED                     = 0x063B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    MSG_CORPSE_QUERY                             = 0x4336,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    SMSG_CHAT_WRONG_FACTION                      = 0x6724,    // 4.3.4 15595 (unverified; no client leaf; unframable >0x1FFF)
    ...
    SMSG_GM_PLAYER_INFO                          = 0x102B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_ITEM_TEXT_QUERY_RESPONSE                = 0x1134,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_SPELLDAMAGESHIELD                       = 0x05F3,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_SPELLNONMELEEDAMAGELOG                  = 0x1450,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    MSG_AUCTION_HELLO                            = 0x2307,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    SMSG_AUCTION_BIDDER_NOTIFICATION             = 0x11C1,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_AUCTION_OWNER_NOTIFICATION              = 0x1A8E,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_PROCRESIST                              = 0x12BE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_COMBAT_EVENT_FAILED                     = 0x18C3,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_CORPSE_RECLAIM_DELAY                    = 0x022A,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    SMSG_STABLE_RESULT                           = 0x14BE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_RAID_GROUP_ONLY                         = 0x0D82,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_AUCTION_REMOVED_NOTIFICATION            = 0x2334,    // 4.3.4 15595 (unverified; no client leaf; unframable >0x1FFF)
    ...
    SMSG_LFG_OFFER_CONTINUE                      = 0x1EAB,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_TEST_DROP_RATE_RESULT                   = 0x1296,    // (value unverified; no client leaf)
    CMSG_LFG_GET_STATUS                          = 0x032D, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SHOW_MAILBOX                            = 0x1F13,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_RESET_RANGED_COMBAT_TIMER               = 0x1299,    // (legacy; no client leaf)
    SMSG_CHAT_NOT_IN_PARTY                       = 0x0A8A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_SET_FORCED_REACTIONS                    = 0x068F,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_SPELL_FAILED_OTHER                      = 0x040B,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_GAMEOBJECT_RESET_STATE                  = 0x100E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_PLAYER_SKINNED                          = 0x1463,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    MSG_PETITION_RENAME                          = 0x4005,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS        = 0x10A6,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_BATTLEGROUND_PLAYER_POSITIONS           = 0x060A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_PLAY_TIME_WARNING                       = 0x062A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    MSG_RAID_TARGET_UPDATE                       = 0x2C36,    // 4.3.4 15595 (no client leaf; unframable >0x1FFF)
    ...
    SMSG_PET_DISMISS_SOUND                       = 0x1ABB,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_GM_TICKET_STATUS_UPDATE                 = 0x000B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_SPELL_UPDATE_CHAIN_TARGETS              = 0x0D52,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    CMSG_CHAT_FILTERED                           = 0x0946, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_EXPECTED_SPAM_RECORDS                   = 0x18C0,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_WORLD_SERVER_INFO                       = 0x0082,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    MSG_GM_RESETINSTANCELIMIT                    = 0x133D,    // (no client leaf)
    SMSG_MOTD                                    = 0x183B,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    ...
    SMSG_LFG_PROPOSAL_UPDATE                     = 0x1E3B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    CMSG_LFG_PROPOSAL_RESPONSE                   = 0x1D9D, // 5.4.8 18414 (Wow.exe binary, via CMSG_LFG_PROPOSAL_RESULT)
    SMSG_LFG_ROLE_CHECK_UPDATE                   = 0x12BB,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_LFG_UPDATE_PLAYER                       = 0x1368,    // (legacy; no client leaf)
    SMSG_LFG_UPDATE_PARTY                        = 0x1369,    // (legacy; no client leaf)
    SMSG_LFG_UPDATE_SEARCH                       = 0x1161,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_LFG_BOOT_PLAYER                         = 0x136E,    // (legacy; no client leaf)
    ...
    SMSG_LFG_PARTY_INFO                          = 0x168E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_ARENA_ERROR                             = 0x04BA,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_FORCED_DEATH_UPDATE                     = 0x0E8F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_OFFER_PETITION_ERROR                    = 0x161E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_TIME_SYNC_REQ                           = 0x1A8F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_REAL_GROUP_UPDATE                       = 0x0F34,    // 4.3.4 15595 (unverified; no client leaf)
    SMSG_LFG_DISABLED                            = 0x008E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_VOICE_SESSION_ROSTER_UPDATE             = 0x000E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_VOICE_SESSION_LEAVE                     = 0x15C0,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_VOICE_PARENTAL_CONTROLS                 = 0x04BF,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_GM_MESSAGECHAT                          = 0x6434,    // (legacy; no client leaf; unframable >0x1FFF)
    ...
    SMSG_COMMENTATOR_MAP_INFO                    = 0x1CBE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_KICK_REASON                             = 0x0A1E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    MSG_RAID_READY_CHECK_FINISHED                = 0x1591,    // 5.3.0 17128 (no client leaf)
    CMSG_COMPLAIN                                = 0x0319, // 5.4.8 18414 (Wow.exe binary)
    SMSG_COMPLAIN_RESULT                         = 0x128F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_CHANNEL_MEMBER_COUNT                    = 0x6414,    // 4.3.4 15595 (unverified; no client leaf; unframable >0x1FFF)
    ...
    SMSG_AVAILABLE_VOICE_CHANNEL                 = 0x029A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_VOICE_CHAT_STATUS                       = 0x10E2,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    CMSG_REPORT_PVP_AFK                          = 0x06F9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_REPORT_PVP_AFK_RESULT                   = 0x18BE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_GROUPACTION_THROTTLED                   = 0x0287,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_QUESTGIVER_STATUS_MULTIPLE              = 0x06CE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_SERVER_BUCK_DATA                        = 0x1142,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_SUMMON_CANCEL                           = 0x000A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_LEARNED_DANCE_MOVES                     = 0x041F,    // 5.4.1 17538 (Wow.exe leaf; name unverified)
    ...
    SMSG_CALENDAR_EVENT_INVITE_NOTES             = 0x11C0,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT       = 0x1286,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_SET_PHASE_SHIFT                         = 0x02A2,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    SMSG_ALL_ACHIEVEMENT_DATA                    = 0x180A,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus)
    SMSG_HEALTH_UPDATE                           = 0x148B,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST              = 0x1E0E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_SERVER_INFO_RESPONSE                    = 0x103A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_SERVER_BUCK_DATA_START                  = 0x14A4,    // (no client leaf)
    SMSG_BATTLEGROUND_INFO_THROTTLED             = 0x1E1E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_PET_GUIDS                               = 0x1227,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_CORPSE_TRANSPORT_QUERY                  = 0x0E0B,    // 5.4.8 18414 (Wow.exe leaf; name reference-consensus; fuzzy via SMSG_CORPSE_QUERY)
    ...
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION     = 0x120A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_BATTLEFIELD_MANAGER_EJECT_PENDING       = 0x003E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire; fuzzy via SMSG_BATTLEFIELD_MGR_EJECT_PENDING)
    ...
    SMSG_GMTICKET_RESOLVE_RESPONSE               = 0x1ABE,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire; via SMSG_GM_TICKET_RESOLVE_RESPONSE)
    ...
    SMSG_TALENTS_INVOLUNTARILY_RESET             = 0x088A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    SMSG_DEBUG_SERVER_GEO                        = 0x14FD,    // (legacy; no client leaf)
    SMSG_LOOT_UPDATE                             = 0x1863,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire; fuzzy via SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT)
    ...
    SMSG_AREA_TRIGGER_NO_CORPSE                  = 0x089E,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: WPP)
    SMSG_CAMERA_SHAKE                            = 0x0C3A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_OPEN_LFG_DUNGEON_FINDER                 = 0x0E8A,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: SkyFire)
    ...
    SMSG_RATED_BG_STATS                          = 0x0394,    // (unverified; no client leaf)
    ...
    SMSG_ARENA_UNIT_DESTROYED                    = 0x000F,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
    ...
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT          = 0x0332,    // 5.4.8 18414 (Wow.exe leaf; name reference single-source: Pandaria)
