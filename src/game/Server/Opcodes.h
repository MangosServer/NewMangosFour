...
enum OpcodesList
{
    ...
    SMSG_AUTH_CHALLENGE                          = 0x0949, // 5.4.8 18414 (reference-consensus)
    CMSG_AUTH_SESSION                            = 0x00B2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_AUTH_RESPONSE                           = 0x0ABA, // 5.4.8 18414 (reference-consensus)
    MSG_NULL_ACTION                              = 0x1001,
    SMSG_DBLOOKUP                                = 0x1004, // not in 5.4.8 (legacy)
    SMSG_QUERY_OBJECT_POSITION                   = 0x1006, // not in 5.4.8 (legacy)
    SMSG_QUERY_OBJECT_ROTATION                   = 0x1008, // not in 5.4.8 (legacy)
    ...
    SMSG_ZONE_MAP                                = 0x100C, // not in 5.4.8 (legacy)
    SMSG_MOVE_CHARACTER_CHEAT                    = 0x100F, // not in 5.4.8 (legacy)
    SMSG_CHECK_FOR_BOTS                          = 0x1016, // not in 5.4.8 (legacy)
    SMSG_FORCEACTIONSHOW                         = 0x101C, // not in 5.4.8 (legacy)
    SMSG_PETGODMODE                              = 0x1940, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_REFER_A_FRIEND_EXPIRED                  = 0x1143, // 5.4.8 18414 (reference-consensus)
    SMSG_GODMODE                                 = 0x1862, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_DEBUG_AISTATE                           = 0x0A2A, // 5.4.8 18414 (reference single-source: SkyFire; via SMSG_DEBUG_AI_STATE)
    CMSG_DESTROY_ITEM                            = 0x0026, // 5.4.8 18414 (Wow.exe binary)
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE            = 0x14BF, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_CHAR_CREATE                             = 0x1CAA, // 5.4.8 18414 (reference-consensus)
    SMSG_CHAR_ENUM                               = 0x11C3, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_CHAR_DELETE                             = 0x0C9F, // 5.4.8 18414 (reference-consensus)
    CMSG_PLAYER_LOGIN                            = 0x158F, // 5.4.8 18414 (Wow.exe binary)
    SMSG_NEW_WORLD                               = 0x1C3B, // 5.4.8 18414 (reference-consensus)
    SMSG_TRANSFER_PENDING                        = 0x061B, // 5.4.8 18414 (reference-consensus)
    SMSG_TRANSFER_ABORTED                        = 0x0C8F, // 5.4.8 18414 (reference-consensus)
    SMSG_CHARACTER_LOGIN_FAILED                  = 0x1A0B, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_LOGIN_SETTIMESPEED                      = 0x082B, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_GAMETIME_UPDATE                         = 0x0E1B, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_GAMETIME_SET                            = 0x0A0F, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_GAMESPEED_SET                           = 0x1048, // NYI in 5.4.8 refs (value unverified)
    SMSG_SERVERTIME                              = 0x1C3E, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_PLAYER_LOGOUT                           = 0x104B, // not in 5.4.8 (legacy; handler retained)
    CMSG_LOGOUT_REQUEST                          = 0x1349, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LOGOUT_RESPONSE                         = 0x008F, // 5.4.8 18414 (reference-consensus)
    SMSG_LOGOUT_COMPLETE                         = 0x142F, // 5.4.8 18414 (reference-consensus)
    CMSG_LOGOUT_CANCEL                           = 0x06C1, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LOGOUT_CANCEL_ACK                       = 0x0AAF, // 5.4.8 18414 (reference-consensus)
    CMSG_NAME_QUERY                              = 0x0328, // 5.4.8 18414 (Wow.exe binary)
    SMSG_NAME_QUERY_RESPONSE                     = 0x169B, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_PET_NAME_QUERY                          = 0x1C62, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PET_NAME_QUERY_RESPONSE                 = 0x0ABE, // 5.4.8 18414 (reference-consensus)
    CMSG_GUILD_QUERY                             = 0x1AB6, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_QUERY_RESPONSE                    = 0x1B79, // 5.4.8 18414 (reference-consensus)
    CMSG_PAGE_TEXT_QUERY                         = 0x1022, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PAGE_TEXT_QUERY_RESPONSE                = 0x081E, // 5.4.8 18414 (reference-consensus)
    CMSG_QUEST_QUERY                             = 0x02D5, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUEST_QUERY_RESPONSE                    = 0x0276, // 5.4.8 18414 (reference-consensus)
    CMSG_GAMEOBJECT_QUERY                        = 0x1461, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GAMEOBJECT_QUERY_RESPONSE               = 0x06BF, // 5.4.8 18414 (reference-consensus)
    CMSG_CREATURE_QUERY                          = 0x0842, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CREATURE_QUERY_RESPONSE                 = 0x048B, // 5.4.8 18414 (reference-consensus)
    CMSG_WHO                                     = 0x18A3, // 5.4.8 18414 (Wow.exe binary)
    SMSG_WHO                                     = 0x161B, // 5.4.8 18414 (reference-consensus)
    CMSG_WHOIS                                   = 0x0308, // 5.3.0 17128 — NYI in 5.4.8 refs (unverified)
    SMSG_WHOIS                                   = 0x12BA, // 5.4.8 18414 (reference-consensus)
    CMSG_CONTACT_LIST                            = 0x0BB4, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CONTACT_LIST                            = 0x1F22, // 5.4.8 18414 (reference-consensus)
    SMSG_FRIEND_STATUS                           = 0x0532, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_GROUP_INVITE                            = 0x0A8F, // 5.4.8 18414 (reference-consensus)
    SMSG_GROUP_CANCEL                            = 0x4D25, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_GROUP_INVITE_RESPONSE                   = 0x0D61, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GROUP_DECLINE                           = 0x17A3, // 5.4.8 18414 (reference-consensus)
    CMSG_GROUP_UNINVITE                          = 0x1076, // not in 5.4.8 (legacy)
    CMSG_GROUP_UNINVITE_GUID                     = 0x0CE1, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GROUP_UNINVITE                          = 0x1313, // 5.4.8 18414 (reference-consensus)
    CMSG_GROUP_SET_LEADER                        = 0x15BB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GROUP_SET_LEADER                        = 0x18BF, // 5.4.8 18414 (reference-consensus)
    CMSG_LOOT_METHOD                             = 0x0DE1, // 5.4.8 18414 (Wow.exe binary)
    CMSG_GROUP_DISBAND                           = 0x1798, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GROUP_DESTROYED                         = 0x1B27, // 5.4.8 18414 (reference-consensus)
    SMSG_GROUP_LIST                              = 0x0CBB, // 5.4.8 18414 (reference-consensus)
    SMSG_PARTY_MEMBER_STATS                      = 0x0A9A, // 5.4.8 18414 (reference-consensus)
    SMSG_PARTY_COMMAND_RESULT                    = 0x0F86, // 5.4.8 18414 (reference-consensus)
    CMSG_GUILD_CREATE                            = 0x1082, // not in 5.4.8 (legacy; handler retained)
    CMSG_GUILD_INVITE                            = 0x0869, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_INVITE                            = 0x0F71, // 5.4.8 18414 (reference-consensus)
    CMSG_GUILD_ACCEPT                            = 0x18A2, // 5.4.8 18414 (Wow.exe binary)
    CMSG_GUILD_DECLINE                           = 0x147B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_DECLINE                           = 0x1AF9, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_GUILD_INFO                              = 0x1088, // not in 5.4.8 (legacy)
    SMSG_GUILD_INFO                              = 0x1089,
    CMSG_GUILD_ROSTER                            = 0x1459, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_ROSTER                            = 0x0BE0, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_GUILD_EVENT                             = 0x0705, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_GUILD_COMMAND_RESULT                    = 0x0EF1, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_GUILD_QUERY_RANKS_RESULT                = 0x0A79, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_GUILD_RANKS)
    ...
    SMSG_MESSAGECHAT                             = 0x1A9A, // 5.4.8 18414 (reference-consensus)
    CMSG_JOIN_CHANNEL                            = 0x148E, // 5.4.8 18414 (Wow.exe binary)
    CMSG_LEAVE_CHANNEL                           = 0x042A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHANNEL_NOTIFY                          = 0x0F06, // 5.4.8 18414 (reference-consensus)
    CMSG_CHANNEL_LIST                            = 0x0C1B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHANNEL_LIST                            = 0x0B22, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_UPDATE_OBJECT                           = 0x1792, // 5.4.8 18414 (reference-consensus)
    SMSG_DESTROY_OBJECT                          = 0x14C2, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_READ_ITEM_OK                            = 0x0305, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_READ_ITEM_RESULT_OK)
    SMSG_READ_ITEM_FAILED                        = 0x0E8B, // 5.4.8 18414 (reference single-source: SkyFire; fuzzy via SMSG_READ_ITEM_RESULT_FAILED)
    SMSG_ITEM_COOLDOWN                           = 0x1904, // 5.4.8 18414 (reference-consensus)
    CMSG_GAMEOBJ_USE                             = 0x06D8, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GAMEOBJECT_CUSTOM_ANIM                  = 0x001F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_MOVE_TELEPORT                           = 0x0B39, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_MOVE_SET_RUN_SPEED                      = 0x184C, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT            = 0x10CF,
    SMSG_MOVE_SET_RUN_BACK_SPEED                 = 0x0A83, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_WALK_SPEED_CHEAT                = 0x10D1,
    SMSG_MOVE_SET_WALK_SPEED                     = 0x0469, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_SWIM_SPEED_CHEAT                = 0x10D3,
    SMSG_MOVE_SET_SWIM_SPEED                     = 0x0817, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT           = 0x10D5,
    SMSG_MOVE_SET_SWIM_BACK_SPEED                = 0x0962, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_ALL_SPEED_CHEAT                 = 0x10D7,
    MSG_MOVE_SET_TURN_RATE_CHEAT                 = 0x10D8,
    SMSG_MOVE_SET_TURN_RATE                      = 0x0069, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_MONSTER_MOVE                            = 0x1A07, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_MOVE_WATER_WALK                         = 0x1F9A, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_LAND_WALK                          = 0x086A, // 5.4.8 18414 (reference-consensus)
    SMSG_FORCE_RUN_SPEED_CHANGE                  = 0x10E3, // not in 5.4.8 (legacy)
    CMSG_FORCE_RUN_SPEED_CHANGE_ACK              = 0x10F3, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK)
    SMSG_FORCE_RUN_BACK_SPEED_CHANGE             = 0x10E5, // not in 5.4.8 (legacy)
    CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK         = 0x0158, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK)
    SMSG_FORCE_SWIM_SPEED_CHANGE                 = 0x10E7, // not in 5.4.8 (legacy)
    CMSG_FORCE_SWIM_SPEED_CHANGE_ACK             = 0x1853, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK)
    SMSG_FORCE_MOVE_ROOT                         = 0x15AE, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_MOVE_ROOT)
    CMSG_FORCE_MOVE_ROOT_ACK                     = 0x107A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_FORCE_MOVE_UNROOT                       = 0x1FAE, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_MOVE_UNROOT)
    ...
    SMSG_MOVE_KNOCK_BACK                         = 0x0562, // 5.4.8 18414 (reference-consensus)
    CMSG_MOVE_KNOCK_BACK_ACK                     = 0x00F2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_MOVE_UPDATE_KNOCK_BACK                  = 0x0251, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_FEATHER_FALL                       = 0x0C60, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_NORMAL_FALL                        = 0x08E0, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_SET_HOVER                          = 0x1802, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_UNSET_HOVER                        = 0x02D3, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_TRIGGER_CINEMATIC                       = 0x0B01, // 5.4.8 18414 (reference-consensus)
    CMSG_NEXT_CINEMATIC_CAMERA                   = 0x1124, // 5.4.8 18414 (Wow.exe binary)
    CMSG_COMPLETE_CINEMATIC                      = 0x1F34, // 5.4.8 18414 (Wow.exe binary)
    SMSG_TUTORIAL_FLAGS                          = 0x1B90, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_EMOTE                                   = 0x0987, // 5.4.8 18414 (reference-consensus)
    CMSG_TEXT_EMOTE                              = 0x07E9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_TEXT_EMOTE                              = 0x002E, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_INVENTORY_CHANGE_FAILURE                = 0x0C1E, // 5.4.8 18414 (reference-consensus)
    SMSG_OPEN_CONTAINER                          = 0x14BB, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_TRADE_STATUS                            = 0x1963, // 5.4.8 18414 (reference-consensus)
    SMSG_TRADE_STATUS_EXTENDED                   = 0x181E, // 5.4.8 18414 (reference-consensus)
    SMSG_INITIALIZE_FACTIONS                     = 0x0AAA, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_FACTION_VISIBLE                     = 0x1E8E, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_FACTION_STANDING                    = 0x10AA, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_FACTION_ATWAR                       = 0x027B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SET_PROFICIENCY                         = 0x1440, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_ACTION_BUTTON                       = 0x1F8C, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ACTION_BUTTONS                          = 0x081A, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_INITIAL_SPELLS                          = 0x045A, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_LEARNED_SPELL                           = 0x129A, // 5.4.8 18414 (reference-consensus)
    SMSG_SUPERCEDED_SPELL                        = 0x1943, // 5.4.8 18414 (reference-consensus)
    CMSG_CAST_SPELL                              = 0x0206, // 5.4.8 18414 (Wow.exe binary)
    CMSG_CANCEL_CAST                             = 0x18C0, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CAST_FAILED                             = 0x143A, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_START                             = 0x107A, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_GO                                = 0x09D8, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_FAILURE                           = 0x04AF, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_COOLDOWN                          = 0x0452, // 5.4.8 18414 (reference-consensus)
    SMSG_COOLDOWN_EVENT                          = 0x1163, // 5.4.8 18414 (reference-consensus)
    CMSG_CANCEL_AURA                             = 0x1861, // 5.4.8 18414 (Wow.exe binary)
    SMSG_EQUIPMENT_SET_ID                        = 0x0006, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_CAST_FAILED                         = 0x149B, // 5.4.8 18414 (reference-consensus)
    SMSG_CHANNEL_START                           = 0x10F9, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_SPELL_CHANNEL_START)
    SMSG_CHANNEL_UPDATE                          = 0x11D9, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_SPELL_CHANNEL_UPDATE)
    CMSG_CANCEL_CHANNELLING                      = 0x08C0, // 5.4.8 18414 (Wow.exe binary)
    SMSG_AI_REACTION                             = 0x06AF, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ATTACKSTART                             = 0x1A9E, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_ATTACKSTOP                              = 0x12AF, // 5.4.8 18414 (reference-consensus)
    SMSG_ATTACKSWING_NOTINRANGE                  = 0x0B36, // not in 5.4.8 (legacy)
    SMSG_ATTACKSWING_BADFACING                   = 0x6C07, // not in 5.4.8 (legacy)
    SMSG_PENDING_RAID_LOCK                       = 0x4F17, // not in 5.4.8 (legacy)
    SMSG_ATTACKSWING_DEADTARGET                  = 0x2B26, // not in 5.4.8 (legacy)
    SMSG_ATTACKSWING_CANT_ATTACK                 = 0x0016, // not in 5.4.8 (legacy)
    SMSG_ATTACKERSTATEUPDATE                     = 0x06AA, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_BATTLEFIELD_PORT_DENIED                 = 0x149A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_RESUME_CAST_BAR                         = 0x01D2, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_CANCEL_COMBAT                           = 0x0534, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELLBREAKLOG                           = 0x6B17, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_SPELLHEALLOG                            = 0x09FB, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_SPELLENERGIZELOG                        = 0x0D79, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_BREAK_TARGET                            = 0x021A, // 5.4.8 18414 (reference-consensus)
    SMSG_BINDPOINTUPDATE                         = 0x0E3B, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_BINDZONEREPLY                           = 0x1158, // not in 5.4.8 (legacy)
    SMSG_PLAYERBOUND                             = 0x088E, // 5.4.8 18414 (reference-consensus)
    SMSG_CLIENT_CONTROL_UPDATE                   = 0x1043, // 5.4.8 18414 (reference-consensus)
    CMSG_REPOP_REQUEST                           = 0x134A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_RESURRECT_REQUEST                       = 0x1062, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_LOOT_RESPONSE                           = 0x128A, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_RELEASE_RESPONSE                   = 0x123F, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_REMOVED                            = 0x0C3E, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_CURRENCY_REMOVED                   = 0x1DB4, // 4.3.4 15595
    SMSG_LOOT_MONEY_NOTIFY                       = 0x14C0, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_ITEM_NOTIFY                        = 0x080F, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_CLEAR_MONEY                        = 0x1632, // 5.4.8 18414 (reference-consensus)
    SMSG_ITEM_PUSH_RESULT                        = 0x0E0A, // 5.4.8 18414 (reference-consensus)
    SMSG_DUEL_REQUESTED                          = 0x0022, // 5.4.8 18414 (reference-consensus)
    SMSG_DUEL_OUTOFBOUNDS                        = 0x001A, // 5.4.8 18414 (reference-consensus)
    SMSG_DUEL_INBOUNDS                           = 0x163A, // 5.4.8 18414 (reference-consensus)
    SMSG_DUEL_COMPLETE                           = 0x1C0A, // 5.4.8 18414 (reference-consensus)
    SMSG_DUEL_WINNER                             = 0x10E1, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_MOUNTRESULT                             = 0x0E0F, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_DISMOUNTRESULT                          = 0x062F, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_REMOVED_FROM_PVP_QUEUE                  = 0x1171, // not in 5.4.8 (legacy)
    CMSG_MOUNTSPECIAL_ANIM                       = 0x0082, // 5.4.8 18414 (Wow.exe binary)
    SMSG_MOUNTSPECIAL_ANIM                       = 0x003A, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_TAME_FAILURE                        = 0x040E, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_PET_NAME_INVALID                        = 0x028E, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_SPELLS                              = 0x095A, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_PET_SPELLS_MESSAGE)
    SMSG_PET_MODE                                = 0x163F, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_GOSSIP_HELLO                            = 0x12F3, // 5.4.8 18414 (Wow.exe binary)
    CMSG_GOSSIP_SELECT_OPTION                    = 0x0748, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GOSSIP_MESSAGE                          = 0x0244, // 5.4.8 18414 (reference-consensus)
    SMSG_GOSSIP_COMPLETE                         = 0x034E, // 5.4.8 18414 (reference-consensus)
    CMSG_NPC_TEXT_QUERY                          = 0x0287, // 5.4.8 18414 (Wow.exe binary)
    SMSG_NPC_TEXT_UPDATE                         = 0x140A, // 5.4.8 18414 (reference-consensus)
    SMSG_NPC_WONT_TALK                           = 0x1182, // not in 5.4.8 (legacy)
    CMSG_QUESTGIVER_STATUS_QUERY                 = 0x036A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUESTGIVER_STATUS                       = 0x1275, // 5.4.8 18414 (reference-consensus)
    CMSG_QUESTGIVER_HELLO                        = 0x02DB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUESTGIVER_QUEST_LIST                   = 0x02D4, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_QUESTGIVER_QUEST_DETAILS                = 0x134C, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_QUESTGIVER_REQUEST_ITEMS                = 0x0277, // 5.4.8 18414 (reference-consensus)
    CMSG_QUESTGIVER_REQUEST_REWARD               = 0x0378, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUESTGIVER_OFFER_REWARD                 = 0x074F, // 5.4.8 18414 (reference-consensus)
    CMSG_QUESTGIVER_CHOOSE_REWARD                = 0x07CB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUESTGIVER_QUEST_INVALID                = 0x027D, // 5.4.8 18414 (reference-consensus)
    CMSG_QUESTGIVER_CANCEL                       = 0x1191, // not in 5.4.8 (legacy; handler retained)
    SMSG_QUESTGIVER_QUEST_COMPLETE               = 0x0346, // 5.4.8 18414 (reference-consensus)
    SMSG_QUESTGIVER_QUEST_FAILED                 = 0x12DE, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_QUESTLOG_FULL                           = 0x07FD, // 5.4.8 18414 (reference-consensus)
    SMSG_QUESTUPDATE_FAILED                      = 0x07DD, // 5.4.8 18414 (reference-consensus)
    SMSG_QUESTUPDATE_FAILEDTIMER                 = 0x06FF, // 5.4.8 18414 (reference-consensus)
    SMSG_QUESTUPDATE_COMPLETE                    = 0x0776, // 5.4.8 18414 (reference-consensus)
    SMSG_QUESTUPDATE_ADD_KILL                    = 0x1645, // 5.4.8 18414 (reference single-source: WPP; via SMSG_QUEST_UPDATE_ADD_KILL)
    SMSG_QUESTUPDATE_ADD_ITEM_OBSOLETE           = 0x119B, // not in 5.4.8 (legacy)
    CMSG_QUEST_CONFIRM_ACCEPT                    = 0x124B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUEST_CONFIRM_ACCEPT                    = 0x13C7, // 5.4.8 18414 (reference-consensus)
    CMSG_PUSHQUESTTOPARTY                        = 0x03D2, // 5.4.8 18414 (Wow.exe binary)
    CMSG_LIST_INVENTORY                          = 0x02D8, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LIST_INVENTORY                          = 0x1AAE, // 5.4.8 18414 (reference-consensus)
    CMSG_SELL_ITEM                               = 0x1358, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SELL_ITEM                               = 0x048E, // 5.4.8 18414 (reference-consensus)
    CMSG_BUY_ITEM                                = 0x02E2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_BUY_ITEM                                = 0x101A, // 5.4.8 18414 (reference-consensus)
    SMSG_BUY_FAILED                              = 0x1563, // 5.4.8 18414 (reference-consensus)
    SMSG_SHOWTAXINODES                           = 0x1E1A, // 5.4.8 18414 (reference-consensus; via SMSG_SHOW_TAXI_NODES)
    CMSG_TAXINODE_STATUS_QUERY                   = 0x02E1, // 5.4.8 18414 (Wow.exe binary, via CMSG_TAXI_NODE_STATUS_QUERY)
    SMSG_TAXINODE_STATUS                         = 0x169E, // 5.4.8 18414 (reference-consensus; via SMSG_TAXI_NODE_STATUS)
    ...
    SMSG_ACTIVATETAXIREPLY                       = 0x02A7, // 5.4.8 18414 (reference-consensus; via SMSG_ACTIVATE_TAXI_REPLY)
    SMSG_NEW_TAXI_PATH                           = 0x141B, // 5.4.8 18414 (reference-consensus)
    CMSG_TRAINER_LIST                            = 0x034B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_TRAINER_LIST                            = 0x189F, // 5.4.8 18414 (reference-consensus)
    CMSG_TRAINER_BUY_SPELL                       = 0x0352, // 5.4.8 18414 (Wow.exe binary)
    SMSG_TRAINER_SERVICE                         = 0x6A05, // not in 5.4.8 (legacy)
    SMSG_TRAINER_BUY_FAILED                      = 0x042E, // 5.4.8 18414 (reference-consensus)
    CMSG_BINDER_ACTIVATE                         = 0x1248, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PLAYERBINDERROR                         = 0x6A24, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_BANKER_ACTIVATE                         = 0x02E9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SHOW_BANK                               = 0x0007, // 5.4.8 18414 (reference-consensus)
    CMSG_BUY_BANK_SLOT                           = 0x12F2, // 5.4.8 18414 (Wow.exe binary)
    CMSG_PETITION_SHOWLIST                       = 0x037B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PETITION_SHOWLIST                       = 0x10A3, // 5.4.8 18414 (reference-consensus)
    CMSG_PETITION_BUY                            = 0x12D9, // 5.4.8 18414 (Wow.exe binary)
    CMSG_PETITION_SHOW_SIGNATURES                = 0x136B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PETITION_SHOW_SIGNATURES                = 0x00AA, // 5.4.8 18414 (reference-consensus)
    CMSG_PETITION_SIGN                           = 0x06DA, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PETITION_SIGN_RESULTS                   = 0x06AE, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_TURN_IN_PETITION_RESULTS                = 0x0E13, // 5.4.8 18414 (reference-consensus)
    CMSG_PETITION_QUERY                          = 0x0255, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PETITION_QUERY_RESPONSE                 = 0x1083, // 5.4.8 18414 (reference-consensus)
    SMSG_FISH_NOT_HOOKED                         = 0x10BE, // 5.4.8 18414 (reference-consensus)
    SMSG_FISH_ESCAPED                            = 0x0227, // 5.4.8 18414 (reference-consensus)
    CMSG_BUG                                     = 0x09E1, // 5.4.8 18414 (Wow.exe binary)
    SMSG_NOTIFICATION                            = 0x0C2A, // 5.4.8 18414 (reference-consensus)
    CMSG_PLAYED_TIME                             = 0x03F6, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PLAYED_TIME                             = 0x11E2, // 5.4.8 18414 (reference-consensus)
    CMSG_QUERY_TIME                              = 0x0640, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUERY_TIME_RESPONSE                     = 0x100F, // 5.4.8 18414 (reference-consensus)
    SMSG_LOG_XPGAIN                              = 0x1E9A, // 5.4.8 18414 (reference-consensus)
    SMSG_AURACASTLOG                             = 0x11D2, // not in 5.4.8 (legacy)
    CMSG_RECLAIM_CORPSE                          = 0x03D3, // 5.4.8 18414 (Wow.exe binary)
    CMSG_WRAP_ITEM                               = 0x02DF, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LEVELUP_INFO                            = 0x1961, // 5.4.8 18414 (reference-consensus)
    MSG_MINIMAP_PING                             = 0x6635, // 4.3.4 15595
    SMSG_RESISTLOG                               = 0x11D7, // not in 5.4.8 (legacy)
    SMSG_ENCHANTMENTLOG                          = 0x12A3, // 5.4.8 18414 (reference-consensus; via SMSG_ENCHANTMENT_LOG)
    SMSG_START_MIRROR_TIMER                      = 0x0E12, // 5.4.8 18414 (reference-consensus)
    SMSG_PAUSE_MIRROR_TIMER                      = 0x162E, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_STOP_MIRROR_TIMER                       = 0x1026, // 5.4.8 18414 (reference-consensus)
    CMSG_PING                                    = 0x0012, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PONG                                    = 0x1969, // 5.4.8 18414 (reference-consensus)
    SMSG_CLEAR_COOLDOWNS                         = 0x1458, // 5.4.8 18414 (reference-consensus)
    SMSG_GAMEOBJECT_PAGETEXT                     = 0x14AF, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_SETSHEATHED                             = 0x0249, // 5.4.8 18414 (Wow.exe binary)
    SMSG_COOLDOWN_CHEAT                          = 0x0432, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_DELAYED                           = 0x087A, // 5.4.8 18414 (reference-consensus)
    CMSG_QUEST_POI_QUERY                         = 0x10C2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUEST_POI_QUERY_RESPONSE                = 0x067F, // 5.4.8 18414 (reference-consensus)
    SMSG_INVALID_PROMOTION_CODE                  = 0x1A0E, // 5.4.8 18414 (reference single-source: SkyFire)
    MSG_GM_BIND_OTHER                            = 0x11E9,
    MSG_GM_SUMMON                                = 0x11EA,
    SMSG_ITEM_TIME_UPDATE                        = 0x18C1, // 5.4.8 18414 (reference-consensus)
    SMSG_ITEM_ENCHANT_TIME_UPDATE                = 0x10A2, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_PLAY_SPELL_VISUAL                       = 0x061E, // 5.4.8 18414 (reference-consensus)
    CMSG_ZONEUPDATE                              = 0x0265, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PARTYKILLLOG                            = 0x048A, // 5.4.8 18414 (reference-consensus)
    SMSG_COMPRESSED_UPDATE_OBJECT                = 0x11F7,
    SMSG_EXPLORATION_EXPERIENCE                  = 0x189A, // 5.4.8 18414 (reference-consensus)
    MSG_RANDOM_ROLL                              = 0x0905, // 4.3.4 15595
    SMSG_ENVIRONMENTALDAMAGELOG                  = 0x0DF1, // 5.4.8 18414 (reference-consensus)
    CMSG_CHANGEPLAYER_DIFFICULTY                 = 0x1F8E, // 5.4.8 18414
    SMSG_RWHOIS                                  = 0x11FF, // NYI in 5.4.8 refs (value unverified)
    SMSG_LFG_PLAYER_REWARD                       = 0x121A, // 5.4.8 18414 (reference-consensus)
    SMSG_LFG_TELEPORT_DENIED                     = 0x063B, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_UNLEARN_SKILL                           = 0x0268, // 5.4.8 18414 (Wow.exe binary)
    SMSG_REMOVED_SPELL                           = 0x14C3, // 5.4.8 18414 (reference-consensus)
    CMSG_GMTICKET_CREATE                         = 0x1A86, // 5.4.8 18414 (Wow.exe binary, via CMSG_GM_TICKET_CREATE)
    SMSG_GMTICKET_CREATE                         = 0x2107, // not in 5.4.8 (legacy)
    CMSG_GMTICKET_UPDATETEXT                     = 0x0A26, // 5.4.8 18414 (Wow.exe binary, via CMSG_GM_TICKET_UPDATE_TEXT)
    SMSG_GMTICKET_UPDATETEXT                     = 0x6535, // not in 5.4.8 (legacy)
    SMSG_ACCOUNT_DATA_TIMES                      = 0x162B, // 5.4.8 18414 (reference-consensus)
    CMSG_REQUEST_ACCOUNT_DATA                    = 0x1D8A, // 5.4.8 18414 (Wow.exe binary)
    CMSG_UPDATE_ACCOUNT_DATA                     = 0x0068, // 5.4.8 18414 (Wow.exe binary)
    SMSG_UPDATE_ACCOUNT_DATA                     = 0x0AAE, // 5.4.8 18414 (reference-consensus)
    SMSG_CLEAR_FAR_SIGHT_IMMEDIATE               = 0x2A04, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_CHANGEPLAYER_DIFFICULTY_RESULT          = 0x2217, // not in 5.4.8 (legacy)
    CMSG_GMTICKET_GETTICKET                      = 0x1F89, // 5.4.8 18414 (Wow.exe binary, via CMSG_GM_TICKET_GET_TICKET)
    SMSG_GMTICKET_GETTICKET                      = 0x129B, // 5.4.8 18414 (reference-consensus; via SMSG_GM_TICKET_GET_TICKET)
    SMSG_INSTANCE_ENCOUNTER                      = 0x1215,
    SMSG_GAMEOBJECT_DESPAWN_ANIM                 = 0x108B, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_GMTICKET_DELETETICKET                   = 0x6D17, // not in 5.4.8 (legacy)
    SMSG_CHAT_WRONG_FACTION                      = 0x6724, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_GMTICKET_SYSTEMSTATUS                   = 0x0A82, // 5.4.8 18414 (Wow.exe binary, via CMSG_GM_TICKET_SYSTEM_STATUS)
    SMSG_GMTICKET_SYSTEMSTATUS                   = 0x163B, // 5.4.8 18414 (reference-consensus; via SMSG_GM_TICKET_SYSTEM_STATUS)
    CMSG_SPIRIT_HEALER_ACTIVATE                  = 0x0340, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUEST_FORCE_REMOVED                     = 0x121F, // not in 5.4.8 (legacy)
    SMSG_SPIRIT_HEALER_CONFIRM                   = 0x1EAA, // 5.4.8 18414 (reference-consensus)
    SMSG_GOSSIP_POI                              = 0x0785, // 5.4.8 18414 (reference-consensus)
    CMSG_CHAT_IGNORED                            = 0x048A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GM_PLAYER_INFO                          = 0x102B, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_LOGIN_VERIFY_WORLD                      = 0x1C0F, // 5.4.8 18414 (reference-consensus)
    CMSG_SEND_MAIL                               = 0x1DBA, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SEND_MAIL_RESULT                        = 0x1A9B, // 5.4.8 18414 (reference-consensus)
    CMSG_GET_MAIL_LIST                           = 0x077A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_MAIL_LIST_RESULT                        = 0x1C0B, // 5.4.8 18414 (reference-consensus)
    CMSG_BATTLEFIELD_LIST                        = 0x1C41, // 5.4.8 18414 (Wow.exe binary)
    SMSG_BATTLEFIELD_LIST                        = 0x160E, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ITEM_TEXT_QUERY_RESPONSE                = 0x1134, // 5.4.8 18414 (reference single-source: Pandaria)
    ...
    SMSG_SPELLLOGMISS                            = 0x1570, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELLLOGEXECUTE                         = 0x0626, // not in 5.4.8 (legacy)
    SMSG_DEBUGAURAPROC                           = 0x124E, // not in 5.4.8 (legacy)
    SMSG_PERIODICAURALOG                         = 0x0416, // not in 5.4.8 (legacy)
    SMSG_SPELLDAMAGESHIELD                       = 0x05F3, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SPELLNONMELEEDAMAGELOG                  = 0x1450, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_LEARN_TALENT                            = 0x02A7, // 5.4.8 18414 (Wow.exe binary)
    SMSG_RESURRECT_FAILED                        = 0x1253, // not in 5.4.8 (legacy)
    CMSG_TOGGLE_PVP                              = 0x0644, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ZONE_UNDER_ATTACK                       = 0x10C2, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_AUCTION_COMMAND_RESULT                  = 0x1002, // 5.4.8 18414 (reference-consensus)
    SMSG_AUCTION_LIST_RESULT                     = 0x0982, // 5.4.8 18414 (reference-consensus)
    SMSG_AUCTION_OWNER_LIST_RESULT               = 0x1785, // 5.4.8 18414 (reference-consensus)
    SMSG_AUCTION_BIDDER_NOTIFICATION             = 0x11C1, // 5.4.8 18414 (reference-consensus)
    SMSG_AUCTION_OWNER_NOTIFICATION              = 0x1A8E, // 5.4.8 18414 (reference-consensus)
    SMSG_PROCRESIST                              = 0x12BE, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_COMBAT_EVENT_FAILED                     = 0x18C3, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_DISPEL_FAILED                           = 0x085B, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELLOGDAMAGE_IMMUNE                    = 0x4507, // not in 5.4.8 (legacy)
    CMSG_AUCTION_LIST_BIDDER_ITEMS               = 0x12D0, // 5.4.8 18414 (Wow.exe binary)
    SMSG_AUCTION_BIDDER_LIST_RESULT              = 0x0B24, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_FLAT_SPELL_MODIFIER                 = 0x10F2, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_PCT_SPELL_MODIFIER                  = 0x09D3, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_AMMO                                = 0x1269, // not in 5.4.8 (legacy; handler retained)
    SMSG_CORPSE_RECLAIM_DELAY                    = 0x022A, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_STABLE_RESULT                           = 0x14BE, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_PLAY_MUSIC                              = 0x0023, // 5.4.8 18414 (reference-consensus)
    SMSG_PLAY_OBJECT_SOUND                       = 0x1443, // 5.4.8 18414 (reference-consensus)
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                  = 0x043E, // 5.4.8 18414 (reference-consensus)
    CMSG_REQUEST_PET_INFO                        = 0x135B, // 5.4.8 18414 (Wow.exe binary)
    CMSG_FAR_SIGHT                               = 0x1341, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SPELLDISPELLOG                          = 0x0DF9, // 5.4.8 18414 (reference-consensus)
    SMSG_DAMAGE_CALC_LOG                         = 0x2436, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_RECEIVED_MAIL                           = 0x182B, // 5.4.8 18414 (reference-consensus)
    SMSG_RAID_GROUP_ONLY                         = 0x0D82, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_SET_PVP_RANK_CHEAT                      = 0x1289, // not in 5.4.8 (legacy)
    CMSG_SET_PVP_TITLE                           = 0x128C, // not in 5.4.8 (legacy)
    SMSG_PVP_CREDIT                              = 0x100A, // 5.4.8 18414 (reference-consensus)
    SMSG_AUCTION_REMOVED_NOTIFICATION            = 0x2334, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_SERVER_MESSAGE                          = 0x0302, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_SAVED_INSTANCE_EXTEND               = 0x0C68, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LFG_OFFER_CONTINUE                      = 0x1EAB, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_TEST_DROP_RATE_RESULT                   = 0x1296, // NYI in 5.4.8 refs (value unverified)
    CMSG_LFG_GET_STATUS                          = 0x032D, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SHOW_MAILBOX                            = 0x1F13, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_RESET_RANGED_COMBAT_TIMER               = 0x1299, // not in 5.4.8 (legacy)
    SMSG_CHAT_NOT_IN_PARTY                       = 0x0A8A, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_CANCEL_GROWTH_AURA                      = 0x0237, // not in 5.4.8 (legacy)
    SMSG_CANCEL_AUTO_REPEAT                      = 0x1E0F, // 5.4.8 18414 (reference-consensus)
    SMSG_STANDSTATE_UPDATE                       = 0x1C12, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_ALL_PASSED                         = 0x0EBB, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_ROLL_WON                           = 0x0A3A, // 5.4.8 18414 (reference-consensus)
    CMSG_LOOT_ROLL                               = 0x15C2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LOOT_START_ROLL                         = 0x0EAA, // 5.4.8 18414 (reference-consensus)
    SMSG_LOOT_ROLL                               = 0x1840, // 5.4.8 18414 (reference-consensus)
    CMSG_LOOT_MASTER_GIVE                        = 0x1DE1, // 5.4.8 18414 (Wow.exe binary)
    SMSG_LOOT_MASTER_LIST                        = 0x02BF, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_FORCED_REACTIONS                    = 0x068F, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_FAILED_OTHER                      = 0x040B, // 5.4.8 18414 (reference-consensus)
    SMSG_GAMEOBJECT_RESET_STATE                  = 0x100E, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_REPAIR_ITEM                             = 0x02C1, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHAT_PLAYER_NOT_FOUND                   = 0x1082, // 5.4.8 18414 (reference-consensus)
    MSG_TALENT_WIPE_CONFIRM                      = 0x0107, // 4.3.4 15595
    SMSG_SUMMON_REQUEST                          = 0x081F, // 5.4.8 18414 (reference-consensus)
    CMSG_SUMMON_RESPONSE                         = 0x0A33, // 5.4.8 18414 (Wow.exe binary)
    MSG_DEV_SHOWLABEL                            = 0x12AE,
    SMSG_MONSTER_MOVE_TRANSPORT                  = 0x2004, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_PET_BROKEN                              = 0x12B0, // NYI in 5.4.8 refs (value unverified)
    MSG_MOVE_FEATHER_FALL                        = 0x12B1,
    MSG_MOVE_WATER_WALK                          = 0x12B2,
    CMSG_SELF_RES                                = 0x0360, // 5.4.8 18414 (Wow.exe binary)
    SMSG_FEIGN_DEATH_RESISTED                    = 0x029E, // 5.4.8 18414 (reference-consensus)
    SMSG_SCRIPT_MESSAGE                          = 0x12B7, // not in 5.4.8 (legacy)
    SMSG_DUEL_COUNTDOWN                          = 0x129F, // 5.4.8 18414 (reference-consensus)
    SMSG_AREA_TRIGGER_MESSAGE                    = 0x4505, // not in 5.4.8 (legacy)
    CMSG_SHOWING_HELM                            = 0x126B, // 5.4.8 18414 (Wow.exe binary)
    CMSG_SHOWING_CLOAK                           = 0x02F2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ROLE_CHOSEN                             = 0x1A1F, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_LFG_ROLE_CHOSEN)
    SMSG_PLAYER_SKINNED                          = 0x1463, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_DURABILITY_DAMAGE_DEATH                 = 0x1E3E, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_ACTIONBAR_TOGGLES                   = 0x0672, // 5.4.8 18414 (Wow.exe binary)
    MSG_PETITION_RENAME                          = 0x4005, // 4.3.4 15595
    SMSG_INIT_WORLD_STATES                       = 0x1560, // 5.4.8 18414 (reference-consensus)
    SMSG_UPDATE_WORLD_STATE                      = 0x121B, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_ACTION_FEEDBACK                     = 0x080E, // 5.4.8 18414 (reference-consensus)
    CMSG_CHAR_RENAME                             = 0x0963, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHAR_RENAME                             = 0x0CBF, // 5.4.8 18414 (reference-consensus)
    CMSG_MOVE_SPLINE_DONE                        = 0x11D9, // 5.4.8 18414 (Wow.exe binary)
    CMSG_MOVE_FALL_RESET                         = 0x00D9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_INSTANCE_SAVE_CREATED                   = 0x1EAE, // 5.4.8 18414 (reference-consensus)
    SMSG_RAID_INSTANCE_INFO                      = 0x16BF, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_PLAY_SOUND                              = 0x102A, // 5.4.8 18414 (reference-consensus)
    CMSG_BATTLEFIELD_STATUS                      = 0x1F9E, // 5.4.8 18414 (Wow.exe binary)
    SMSG_BATTLEFIELD_STATUS                      = 0x0433, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEFIELD_STATUS_ACTIVE               = 0x1AAF, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEFIELD_STATUS_FAILED               = 0x1140, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEFIELD_STATUS_QUEUED               = 0x122E, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION     = 0x1EAF, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS        = 0x10A6, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_BATTLEFIELD_PORT                        = 0x1379, // 5.4.8 18414 (Wow.exe binary)
    CMSG_INSPECT_HONOR_STATS                     = 0x19C3, // 5.4.8 18414 (Wow.exe binary)
    SMSG_INSPECT_HONOR_STATS                     = 0x1A1E, // 5.4.8 18414 (reference-consensus)
    CMSG_BATTLEMASTER_HELLO                      = 0x0234, // not in 5.4.8 (legacy; handler retained)
    SMSG_FORCE_WALK_SPEED_CHANGE                 = 0x12DB, // not in 5.4.8 (legacy)
    CMSG_FORCE_WALK_SPEED_CHANGE_ACK             = 0x00DB, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK)
    SMSG_FORCE_SWIM_BACK_SPEED_CHANGE            = 0x12DD, // not in 5.4.8 (legacy)
    CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK        = 0x10D1, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK)
    SMSG_FORCE_TURN_RATE_CHANGE                  = 0x12DF, // not in 5.4.8 (legacy)
    ...
    SMSG_PVP_LOG_DATA                            = 0x1E8F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_AREA_SPIRIT_HEALER_TIME                 = 0x188E, // 5.4.8 18414 (reference-consensus)
    SMSG_WARDEN_DATA                             = 0x0C0A, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_BATTLEGROUND_PLAYER_POSITIONS           = 0x060A, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_PET_STOP_ATTACK                         = 0x065B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_BINDER_CONFIRM                          = 0x1287, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEGROUND_PLAYER_JOINED              = 0x1E2F, // 5.4.8 18414 (reference-consensus)
    SMSG_BATTLEGROUND_PLAYER_LEFT                = 0x0206, // 5.4.8 18414 (reference-consensus)
    CMSG_BATTLEMASTER_JOIN                       = 0x0769, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ADDON_INFO                              = 0x160A, // 5.4.8 18414 (reference-consensus)
    CMSG_PET_UNLEARN                             = 0x12F1, // not in 5.4.8 (legacy; handler retained)
    SMSG_PET_UNLEARN_CONFIRM                     = 0x12F2, // not in 5.4.8 (legacy)
    ...
    SMSG_WEATHER                                 = 0x06AB, // 5.4.8 18414 (reference-consensus)
    SMSG_PLAY_TIME_WARNING                       = 0x062A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_MINIGAME_SETUP                          = 0x12F7, // NYI in 5.4.8 refs (value unverified)
    SMSG_MINIGAME_STATE                          = 0x12F8, // NYI in 5.4.8 refs (value unverified)
    CMSG_MINIGAME_MOVE                           = 0x12F9, // NYI in 5.4.8 refs (value unverified)
    SMSG_MINIGAME_MOVE_FAILED                    = 0x12FA, // not in 5.4.8 (legacy)
    SMSG_RAID_INSTANCE_MESSAGE                   = 0x0CAF, // 5.4.8 18414 (reference-consensus)
    SMSG_COMPRESSED_MOVES                        = 0x0517, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_GUILD_INFO_TEXT                         = 0x0C70, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHAT_RESTRICTED                         = 0x1A3B, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_SPLINE_MOVE_UNROOT                      = 0x01E1, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_FEATHER_FALL                = 0x3DA5, // 4.3.4 15595
    SMSG_SPLINE_MOVE_NORMAL_FALL                 = 0x38B2, // 4.3.4 15595
    SMSG_SPLINE_MOVE_SET_HOVER                   = 0x0258, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_UNSET_HOVER                 = 0x0CE1, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_WATER_WALK                  = 0x50A2, // 4.3.4 15595
    SMSG_SPLINE_MOVE_LAND_WALK                   = 0x3DA7, // 4.3.4 15595
    SMSG_SPLINE_MOVE_START_SWIM                  = 0x0F29, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_STOP_SWIM                   = 0x1798, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_RUN_MODE                = 0x0B18, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_WALK_MODE               = 0x1865, // 5.4.8 18414 (reference-consensus)
    MSG_GM_DESTROY_CORPSE                        = 0x1311,
    CMSG_ACTIVATETAXIEXPRESS                     = 0x06FB, // 5.4.8 18414 (Wow.exe binary, via CMSG_ACTIVATE_TAXI_EXPRESS)
    SMSG_SET_FACTION_ATWAR                       = 0x0C9B, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_FACTION_NOT_VISIBLE                 = 0x0000, //TODO: Needs fixing up
    SMSG_GAMETIMEBIAS_SET                        = 0x1315, // not in 5.4.8 (legacy)
    ...
    SMSG_SPLINE_MOVE_ROOT                        = 0x0728, // 5.4.8 18414 (reference-consensus)
    SMSG_INVALIDATE_PLAYER                       = 0x102E, // 5.4.8 18414 (reference-consensus)
    CMSG_RESET_INSTANCES                         = 0x0C69, // 5.4.8 18414 (Wow.exe binary)
    SMSG_INSTANCE_RESET                          = 0x160F, // 5.4.8 18414 (reference-consensus)
    SMSG_INSTANCE_RESET_FAILED                   = 0x0026, // 5.4.8 18414 (reference-consensus)
    SMSG_UPDATE_LAST_INSTANCE                    = 0x189B, // 5.4.8 18414 (reference-consensus)
    MSG_RAID_TARGET_UPDATE                       = 0x2C36, // 4.3.4 15595
    MSG_RAID_READY_CHECK                         = 0x0DDC, // 5.3.0 17128
    SMSG_PET_ACTION_SOUND                        = 0x15E2, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_DISMISS_SOUND                       = 0x1ABB, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_GHOSTEE_GONE                            = 0x1327, // not in 5.4.8 (legacy)
    CMSG_GM_UPDATE_TICKET_STATUS                 = 0x15A8, // 5.4.8 18414 (Wow.exe binary, via CMSG_GM_TICKET_CASE_STATUS)
    SMSG_GM_TICKET_STATUS_UPDATE                 = 0x000B, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_UPDATE_INSTANCE_OWNERSHIP               = 0x10E0, // 5.4.8 18414 (reference-consensus)
    SMSG_CHAT_PLAYER_AMBIGUOUS                   = 0x061A, // 5.4.8 18414 (reference-consensus)
    MSG_DELAY_GHOST_TELEPORT                     = 0x132F,
    SMSG_SPELLINSTAKILLLOG                       = 0x09F8, // 5.4.8 18414 (reference-consensus)
    SMSG_SPELL_UPDATE_CHAIN_TARGETS              = 0x0D52, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_CHAT_FILTERED                           = 0x0946, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_EXPECTED_SPAM_RECORDS                   = 0x18C0, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SPELLSTEALLOG                           = 0x4E26, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_LOTTERY_QUERY_RESULT_OBSOLETE           = 0x1336, // not in 5.4.8 (legacy)
    SMSG_LOTTERY_RESULT_OBSOLETE                 = 0x1338, // not in 5.4.8 (legacy)
    SMSG_CHARACTER_PROFILE                       = 0x1339, // not in 5.4.8 (legacy)
    SMSG_CHARACTER_PROFILE_REALM_CONNECTED       = 0x133A, // not in 5.4.8 (legacy)
    SMSG_DEFENSE_MESSAGE                         = 0x0A1F, // 5.4.8 18414 (reference-consensus)
    SMSG_WORLD_SERVER_INFO                       = 0x0082, // 5.4.8 18414 (reference-consensus)
    MSG_GM_RESETINSTANCELIMIT                    = 0x133D,
    SMSG_MOTD                                    = 0x183B, // 5.4.8 18414 (reference-consensus)
    SMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x133F,
    SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x0868, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ARENA_TEAM_COMMAND_RESULT               = 0x06C1, // not in 5.4.8 (legacy)
    ...
    SMSG_ARENA_TEAM_EVENT                        = 0x0617, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_ARENA_TEAM_STATS                        = 0x4425, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_LFG_SEARCH_RESULTS                      = 0x1361, // not in 5.4.8 (legacy)
    SMSG_LFG_PROPOSAL_UPDATE                     = 0x1E3B, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_LFG_PROPOSAL_RESPONSE                   = 0x1D9D, // 5.4.8 18414 (Wow.exe binary, via CMSG_LFG_PROPOSAL_RESULT)
    SMSG_LFG_ROLE_CHECK_UPDATE                   = 0x12BB, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_LFG_JOIN_RESULT                         = 0x18E3, // 5.4.8 18414 (reference-consensus)
    SMSG_LFG_QUEUE_STATUS                        = 0x1366, // not in 5.4.8 (legacy)
    CMSG_SET_LFG_COMMENT                         = 0x0530, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_LFG_UPDATE_PLAYER                       = 0x1368, // not in 5.4.8 (legacy)
    SMSG_LFG_UPDATE_PARTY                        = 0x1369, // not in 5.4.8 (legacy)
    SMSG_LFG_UPDATE_SEARCH                       = 0x1161, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_LFG_BOOT_PLAYER                         = 0x136E, // not in 5.4.8 (legacy)
    CMSG_LFG_GET_PLAYER_INFO                     = 0x136F, // not in 5.4.8 (legacy)
    SMSG_LFG_PLAYER_INFO                         = 0x1861, // 5.4.8 18414 (reference-consensus)
    CMSG_LFG_TELEPORT                            = 0x1AA6, // 5.4.8 18414 (Wow.exe binary)
    CMSG_LFG_GET_PARTY_INFO                      = 0x1372, // not in 5.4.8 (legacy)
    SMSG_LFG_PARTY_INFO                          = 0x168E, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_TITLE_EARNED                            = 0x068E, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_TITLE                               = 0x03C7, // 5.4.8 18414 (Wow.exe binary)
    CMSG_CANCEL_MOUNT_AURA                       = 0x1552, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ARENA_ERROR                             = 0x04BA, // 5.4.8 18414 (reference single-source: Pandaria)
    MSG_INSPECT_ARENA_TEAMS                      = 0x2704, // 4.3.4 15595
    SMSG_DEATH_RELEASE_LOC                       = 0x1063, // 5.4.8 18414 (reference-consensus)
    CMSG_CANCEL_TEMP_ENCHANTMENT                 = 0x024B, // 5.4.8 18414 (Wow.exe binary)
    SMSG_FORCED_DEATH_UPDATE                     = 0x0E8F, // 5.4.8 18414 (reference single-source: SkyFire)
    MSG_MOVE_SET_FLIGHT_SPEED_CHEAT              = 0x137E,
    SMSG_MOVE_SET_FLIGHT_SPEED                   = 0x006E, // 5.4.8 18414 (reference-consensus)
    MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT         = 0x1380,
    SMSG_MOVE_SET_FLIGHT_BACK_SPEED              = 0x0319, // 5.4.8 18414 (reference-consensus)
    SMSG_FORCE_FLIGHT_SPEED_CHANGE               = 0x1382, // not in 5.4.8 (legacy)
    CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK           = 0x09DA, // 5.4.8 18414 (Wow.exe binary, via CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK)
    SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE          = 0x1384, // not in 5.4.8 (legacy)
    ...
    SMSG_FLIGHT_SPLINE_SYNC                      = 0x0063, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_TAXI_BENCHMARK_MODE                 = 0x0762, // 5.4.8 18414 (Wow.exe binary)
    SMSG_JOINED_BATTLEGROUND_QUEUE               = 0x138B, // not in 5.4.8 (legacy)
    SMSG_REALM_SPLIT                             = 0x1A2E, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_OFFER_PETITION_ERROR                    = 0x161E, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_TIME_SYNC_REQ                           = 0x1A8F, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_TIME_SYNC_RESP                          = 0x01DB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_RESET_FAILED_NOTIFY                     = 0x10AE, // 5.4.8 18414 (reference-consensus)
    SMSG_REAL_GROUP_UPDATE                       = 0x0F34, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_LFG_DISABLED                            = 0x008E, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE    = 0x139C, // not in 5.4.8 (legacy)
    SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE_WRITE_FILE = 0x139D, // not in 5.4.8 (legacy)
    SMSG_UPDATE_COMBO_POINTS                     = 0x082F, // 5.4.8 18414 (reference-consensus)
    SMSG_VOICE_SESSION_ROSTER_UPDATE             = 0x000E, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_VOICE_SESSION_LEAVE                     = 0x15C0, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_VOICE_SESSION_ADJUST_PRIORITY           = 0x13A1, // not in 5.4.8 (legacy)
    SMSG_VOICE_SET_TALKER_MUTED                  = 0x13A3, // NYI in 5.4.8 refs (value unverified)
    SMSG_INIT_EXTRA_AURA_INFO_OBSOLETE           = 0x13A4, // not in 5.4.8 (legacy)
    SMSG_SET_EXTRA_AURA_INFO_OBSOLETE            = 0x13A5, // not in 5.4.8 (legacy)
    SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE_OBSOLETE = 0x13A6,
    SMSG_CLEAR_EXTRA_AURA_INFO_OBSOLETE          = 0x13A7, // not in 5.4.8 (legacy)
    CMSG_MOVE_START_DESCEND                      = 0x01D1, // 5.4.8 18414
    SMSG_IGNORE_REQUIREMENTS_CHEAT               = 0x13AA, // not in 5.4.8 (legacy)
    SMSG_SPELL_CHANCE_PROC_LOG                   = 0x13AB, // not in 5.4.8 (legacy)
    SMSG_DISMOUNT                                = 0x0E3A, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_VOICE_SESSION_ENABLE                    = 0x13B1, // not in 5.4.8 (legacy)
    SMSG_VOICE_PARENTAL_CONTROLS                 = 0x04BF, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_GM_MESSAGECHAT                          = 0x6434, // not in 5.4.8 (legacy)
    MSG_GM_GEARRATING                            = 0x13B5,
    CMSG_COMMENTATOR_ENABLE                      = 0x0B07, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMMENTATOR_STATE_CHANGED               = 0x0737, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_COMMENTATOR_GET_MAP_INFO                = 0x0026, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMMENTATOR_MAP_INFO                    = 0x1CBE, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_COMMENTATOR_GET_PLAYER_INFO             = 0x0D14, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMMENTATOR_GET_PLAYER_INFO             = 0x13BB, // not in 5.4.8 (legacy)
    SMSG_COMMENTATOR_PLAYER_INFO                 = 0x2F36, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_CLEAR_TARGET                            = 0x1061, // 5.4.8 18414 (reference-consensus)
    SMSG_CROSSED_INEBRIATION_THRESHOLD           = 0x1E9E, // 5.4.8 18414 (reference-consensus)
    CMSG_CHEAT_PLAYER_LOGIN                      = 0x13C3, // not in 5.4.8 (legacy)
    SMSG_CHEAT_PLAYER_LOOKUP                     = 0x13C5, // not in 5.4.8 (legacy)
    SMSG_KICK_REASON                             = 0x0A1E, // 5.4.8 18414 (reference single-source: SkyFire)
    MSG_RAID_READY_CHECK_FINISHED                = 0x1591, // 5.3.0 17128
    CMSG_COMPLAIN                                = 0x0319, // 5.4.8 18414 (Wow.exe binary)
    SMSG_COMPLAIN_RESULT                         = 0x128F, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_FEATURE_SYSTEM_STATUS                   = 0x16BB, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_CHANNEL_MEMBER_COUNT                    = 0x6414, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_CHANNEL_VOICE_ON                        = 0x1144, // not in 5.4.8 (legacy)
    CMSG_CHANNEL_VOICE_OFF                       = 0x13D8, // not in 5.4.8 (legacy)
    SMSG_DEBUG_LIST_TARGETS                      = 0x13DA, // not in 5.4.8 (legacy)
    SMSG_AVAILABLE_VOICE_CHANNEL                 = 0x029A, // 5.4.8 18414 (reference single-source: SkyFire)
    ...
    SMSG_COMSAT_RECONNECT_TRY                    = 0x4D35, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMSAT_DISCONNECT                       = 0x0316, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMSAT_CONNECT_FAIL                     = 0x6317, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_VOICE_CHAT_STATUS                       = 0x10E2, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_REPORT_PVP_AFK                          = 0x06F9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_REPORT_PVP_AFK_RESULT                   = 0x18BE, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_GUILD_BANKER_ACTIVATE                   = 0x0372, // 5.4.8 18414 (Wow.exe binary)
    CMSG_GUILD_BANK_QUERY_TAB                    = 0x1372, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_BANK_LIST                         = 0x0B79, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_GUILD_BANK_LOG_QUERY_RESULT             = 0x0FF0, // 5.4.8 18414 (reference-consensus)
    CMSG_SET_CHANNEL_WATCH                       = 0x4517, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_USERLIST_ADD                            = 0x1462, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_LOOT_LIST                               = 0x1C3F, // 5.4.8 18414 (reference-consensus)
    SMSG_VOICESESSION_FULL                       = 0x6225, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_GUILD_PERMISSIONS                       = 0x145A, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_PERMISSIONS                       = 0x0FF9, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_GUILD_PERMISSIONS_QUERY_RESULTS)
    CMSG_GUILD_BANK_MONEY_WITHDRAWN              = 0x14DB, // 5.4.8 18414 (Wow.exe binary, via CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY)
    SMSG_GUILD_BANK_MONEY_WITHDRAWN              = 0x0B78, // 5.4.8 18414 (reference-consensus)
    CMSG_GUILD_EVENT_LOG_QUERY                   = 0x15D9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_GUILD_EVENT_LOG                         = 0x1AF1, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_GUILD_EVENT_LOG_QUERY_RESULT)
    CMSG_GET_MIRRORIMAGE_DATA                    = 0x02A3, // 5.4.8 18414 (Wow.exe binary, via CMSG_GET_MIRROR_IMAGE_DATA)
    SMSG_MIRRORIMAGE_DATA                        = 0x2634, // not in 5.4.8 (legacy)
    SMSG_FORCE_DISPLAY_UPDATE                    = 0x1404, // not in 5.4.8 (legacy)
    SMSG_SPELL_CHANCE_RESIST_PUSHBACK            = 0x1405, // not in 5.4.8 (legacy)
    SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT        = 0x0125, // not in 5.4.8 (legacy)
    ...
    SMSG_GROUPACTION_THROTTLED                   = 0x0287, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_OVERRIDE_LIGHT                          = 0x068A, // 5.4.8 18414 (reference-consensus)
    SMSG_TOTEM_CREATED                           = 0x1C8F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_QUESTGIVER_STATUS_MULTIPLE              = 0x06CE, // 5.4.8 18414 (reference single-source: Pandaria)
    CMSG_SET_PLAYER_DECLINED_NAMES               = 0x09E2, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT        = 0x180E, // 5.4.8 18414 (reference-consensus)
    SMSG_SERVER_BUCK_DATA                        = 0x1142, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SEND_UNLEARN_SPELLS                     = 0x10F1, // 5.4.8 18414 (reference-consensus)
    SMSG_PROPOSE_LEVEL_GRANT                     = 0x109A, // 5.4.8 18414 (reference-consensus)
    CMSG_ACCEPT_LEVEL_GRANT                      = 0x02FB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_REFER_A_FRIEND_FAILURE                  = 0x021E, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_FLYING                  = 0x1046, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_UNSET_FLYING                = 0x0DE2, // 5.4.8 18414 (reference-consensus)
    SMSG_SUMMON_CANCEL                           = 0x000A, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_ALTER_APPEARANCE                        = 0x07F0, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ENABLE_BARBER_SHOP                      = 0x1222, // 5.4.8 18414 (reference-consensus)
    SMSG_BARBER_SHOP_RESULT                      = 0x0C3F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_CALENDAR_COMMAND_RESULT                 = 0x142A, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED             = 0x0CAB, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED           = 0x11E0, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_EVENT_INVITE_ALERT             = 0x0A9F, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT     = 0x122B, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT      = 0x0412, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_EVENT_REMOVED_ALERT            = 0x049B, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_EVENT_UPDATED_ALERT            = 0x0A0E, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_CALENDAR_SEND_NUM_PENDING               = 0x0A3F, // 5.4.8 18414 (reference-consensus)
    SMSG_NOTIFY_DANCE                            = 0x4904, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_PLAY_DANCE                              = 0x4704, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_STOP_DANCE                              = 0x2907, // not in 5.4.8 (legacy)
    SMSG_STOP_DANCE                              = 0x4637, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    CMSG_SYNC_DANCE                              = 0x0036, // not in 5.4.8 (legacy)
    CMSG_DANCE_QUERY                             = 0x4E07, // not in 5.4.8 (legacy)
    SMSG_DANCE_QUERY_RESPONSE                    = 0x2F06, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_INVALIDATE_DANCE                        = 0x0E27, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_LEARNED_DANCE_MOVES                     = 0x041F, // 5.4.1 17538 — NYI in 5.4.8 refs (unverified)
    MSG_MOVE_SET_PITCH_RATE_CHEAT                = 0x145B,
    SMSG_MOVE_SET_PITCH_RATE                     = 0x17AB, // 5.4.8 18414 (reference-consensus)
    SMSG_FORCE_PITCH_RATE_CHANGE                 = 0x145D, // not in 5.4.8 (legacy)
    ...
    SMSG_CALENDAR_EVENT_INVITE_NOTES             = 0x11C0, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT       = 0x1286, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_UPDATE_MISSILE_TRAJECTORY               = 0x781E, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_UPDATE_ACCOUNT_DATA_COMPLETE            = 0x2015, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_TRIGGER_MOVIE                           = 0x1C2E, // 5.4.8 18414 (reference-consensus)
    CMSG_COMPLETE_MOVIE                          = 0x1362, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ACHIEVEMENT_EARNED                      = 0x080B, // 5.4.8 18414 (reference-consensus)
    SMSG_DYNAMIC_DROP_ROLL_RESULT                = 0x146A, // not in 5.4.8 (legacy)
    SMSG_CRITERIA_UPDATE                         = 0x0E9B, // 5.4.8 18414 (reference-consensus)
    CMSG_QUERY_INSPECT_ACHIEVEMENTS              = 0x0373, // 5.4.8 18414 (Wow.exe binary)
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS            = 0x009E, // 5.4.8 18414 (reference-consensus)
    CMSG_DISMISS_CONTROLLED_VEHICLE              = 0x09FA, // 5.4.8 18414 (Wow.exe binary)
    SMSG_QUESTUPDATE_ADD_PVP_KILL                = 0x0256, // 5.4.8 18414 (reference-consensus)
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED           = 0x0E1F, // 5.4.8 18414 (reference-consensus)
    CMSG_CHAR_CUSTOMIZE                          = 0x0A13, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHAR_CUSTOMIZE                          = 0x1432, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_RENAMEABLE                          = 0x2B27, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    ...
    SMSG_SET_PHASE_SHIFT                         = 0x02A2, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_ALL_ACHIEVEMENT_DATA                    = 0x180A, // 5.4.8 18414 (reference-consensus)
    SMSG_HEALTH_UPDATE                           = 0x148B, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_POWER_UPDATE                            = 0x109F, // 5.4.8 18414 (reference-consensus)
    CMSG_GAMEOBJ_REPORT_USE                      = 0x06D9, // 5.4.8 18414 (Wow.exe binary)
    SMSG_HIGHEST_THREAT_UPDATE                   = 0x14AE, // 5.4.8 18414 (reference-consensus)
    SMSG_THREAT_UPDATE                           = 0x0632, // 5.4.8 18414 (reference-consensus)
    SMSG_THREAT_REMOVE                           = 0x1960, // 5.4.8 18414 (reference-consensus)
    SMSG_THREAT_CLEAR                            = 0x180B, // 5.4.8 18414 (reference-consensus)
    SMSG_CONVERT_RUNE                            = 0x1A1B, // 5.4.8 18414 (reference-consensus)
    SMSG_RESYNC_RUNES                            = 0x15E3, // 5.4.8 18414 (reference-consensus)
    SMSG_ADD_RUNE_POWER                          = 0x1860, // 5.4.8 18414 (reference-consensus)
    CMSG_REMOVE_GLYPH                            = 0x148B, // not in 5.4.8 (legacy; handler retained)
    SMSG_DUMP_OBJECTS_DATA                       = 0x148D, // not in 5.4.8 (legacy)
    CMSG_DISMISS_CRITTER                         = 0x12DB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST              = 0x1E0E, // 5.4.8 18414 (reference single-source: SkyFire)
    CMSG_AUCTION_LIST_PENDING_SALES              = 0x02DA, // 5.4.8 18414 (Wow.exe binary)
    SMSG_AUCTION_LIST_PENDING_SALES              = 0x0B81, // 5.4.8 18414 (reference-consensus)
    SMSG_MODIFY_COOLDOWN                         = 0x1E2E, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_UPDATE_COMBO_POINTS                 = 0x1206, // 5.4.8 18414 (reference-consensus)
    CMSG_ENABLETAXI                              = 0x0741, // 5.4.8 18414 (Wow.exe binary, via CMSG_ENABLE_TAXI)
    SMSG_PRE_RESURRECT                           = 0x19C0, // 5.4.8 18414 (reference-consensus)
    SMSG_AURA_UPDATE_ALL                         = 0x6916, // 5.3.0 17128
    SMSG_AURA_UPDATE                             = 0x0072, // 5.4.8 18414 (reference-consensus)
    SMSG_SERVER_FIRST_ACHIEVEMENT                = 0x028B, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_LEARNED_SPELL                       = 0x0282, // 5.4.8 18414 (reference-consensus)
    SMSG_PET_REMOVED_SPELL                       = 0x1CAE, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA    = 0x1A2A, // 5.4.8 18414 (reference-consensus)
    SMSG_CRITERIA_DELETED                        = 0x1C33, // 5.4.8 18414 (reference-consensus)
    SMSG_ACHIEVEMENT_DELETED                     = 0x1A2F, // 5.4.8 18414 (reference-consensus)
    SMSG_SERVER_INFO_RESPONSE                    = 0x103A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SERVER_BUCK_DATA_START                  = 0x14A4,
    SMSG_BATTLEGROUND_INFO_THROTTLED             = 0x1E1E, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SET_VEHICLE_REC_ID                      = 0x149F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_PET_GUIDS                               = 0x1227, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_CLIENTCACHE_VERSION                     = 0x002A, // 5.4.8 18414 (reference-consensus)
    SMSG_SET_ITEM_PURCHASE_DATA                  = 0x1C9A, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ITEM_PURCHASE_REFUND_RESULT             = 0x049E, // 5.4.8 18414 (reference-consensus)
    CMSG_CORPSE_TRANSPORT_QUERY                  = 0x1FBE, // 5.4.8 18414 (Wow.exe binary, via CMSG_CORPSE_QUERY)
    SMSG_CORPSE_TRANSPORT_QUERY                  = 0x0E0B, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_CORPSE_QUERY)
    CMSG_CALENDAR_EVENT_SIGNUP                   = 0x01E3, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CALENDAR_CLEAR_PENDING_ACTION           = 0x1E3A, // 5.4.8 18414 (reference-consensus)
    SMSG_LOAD_EQUIPMENT_SET                      = 0x18E2, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION     = 0x120A, // 5.4.8 18414 (reference single-source: Pandaria)
    SMSG_TALENT_UPDATE                           = 0x0A9B, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_UPDATE_TALENT_DATA)
    CMSG_LEARN_TALENT_GROUP                      = 0x2415, // not in 5.4.8 (legacy)
    CMSG_PET_LEARN_TALENT_GROUP                  = 0x6E24, // not in 5.4.8 (legacy)
    SMSG_DESTROY_ARENA_UNIT                      = 0x2637, // not in 5.4.8 (legacy)
    SMSG_ARENA_TEAM_CHANGE_FAILED                = 0x6E34, // not in 5.4.8 (legacy)
    SMSG_PROFILEDATA_RESPONSE                    = 0x14CB, // not in 5.4.8 (legacy)
    SMSG_COMPOUND_MOVE                           = 0x0061, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_MOVE_SET_COMPOUND_STATE)
    SMSG_MOVE_GRAVITY_DISABLE                    = 0x159F, // 5.4.8 18414 (reference-consensus)
    CMSG_MOVE_GRAVITY_DISABLE_ACK                = 0x09D3, // 5.4.8 18414 (Wow.exe binary)
    SMSG_MOVE_GRAVITY_ENABLE                     = 0x0A27, // 5.4.8 18414 (reference-consensus)
    CMSG_MOVE_GRAVITY_ENABLE_ACK                 = 0x11D8, // 5.4.8 18414 (Wow.exe binary)
    MSG_MOVE_GRAVITY_CHNG                        = 0x14D3,
    SMSG_SPLINE_MOVE_GRAVITY_DISABLE             = 0x0845, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE              = 0x0865, // 5.4.8 18414 (reference-consensus)
    CMSG_USE_EQUIPMENT_SET                       = 0x036E, // 5.4.8 18414 (Wow.exe binary, via CMSG_EQUIPMENT_SET_USE)
    SMSG_USE_EQUIPMENT_SET_RESULT                = 0x0A2B, // 5.4.8 18414 (reference-consensus)
    SMSG_FORCE_ANIM                              = 0x4C05, // not in 5.4.8 (legacy)
    CMSG_CHAR_FACTION_CHANGE                     = 0x0329, // 5.4.8 18414 (Wow.exe binary)
    SMSG_CHAR_FACTION_CHANGE                     = 0x4C06, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_PVP_QUEUE_STATS                         = 0x14DD, // not in 5.4.8 (legacy)
    SMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE        = 0x1226, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_BATTLEFIELD_MGR_ENTRY_INVITE)
    ...
    SMSG_BATTLEFIELD_MANAGER_ENTERING            = 0x14E1, // not in 5.4.8 (legacy)
    SMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE        = 0x142E, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_BATTLEFIELD_MGR_QUEUE_INVITE)
    ...
    SMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST_RESPONSE = 0x08BE, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE)
    SMSG_BATTLEFIELD_MANAGER_EJECT_PENDING       = 0x003E, // 5.4.8 18414 (reference single-source: SkyFire; fuzzy via SMSG_BATTLEFIELD_MGR_EJECT_PENDING)
    SMSG_BATTLEFIELD_MANAGER_EJECTED             = 0x14E7, // not in 5.4.8 (legacy)
    CMSG_BATTLEFIELD_MANAGER_EXIT_REQUEST        = 0x08B3, // 5.4.8 18414 (Wow.exe binary, via CMSG_BATTLEFIELD_MGR_EXIT_REQUEST)
    SMSG_BATTLEFIELD_MANAGER_STATE_CHANGED       = 0x14E9, // not in 5.4.8 (legacy)
    MSG_SET_RAID_DIFFICULTY                      = 0x0614, // 4.3.4 15595
    SMSG_XPGAIN                                  = 0x14EE, // not in 5.4.8 (legacy)
    SMSG_GMTICKET_RESPONSE_ERROR                 = 0x14EF, // not in 5.4.8 (legacy)
    SMSG_GMTICKET_GET_RESPONSE                   = 0x2E34, // not in 5.4.8 (legacy)
    SMSG_GMTICKET_RESOLVE_RESPONSE               = 0x1ABE, // 5.4.8 18414 (reference single-source: SkyFire; via SMSG_GM_TICKET_RESOLVE_RESPONSE)
    SMSG_GMTICKET_CREATE_RESPONSE_TICKET         = 0x14F3, // not in 5.4.8 (legacy)
    CMSG_GM_CREATE_TICKET_RESPONSE               = 0x14F4, // not in 5.4.8 (legacy)
    SMSG_SERVERINFO                              = 0x1091, // not in 5.4.8 (legacy)
    CMSG_UI_TIME_REQUEST                         = 0x15AB, // 5.4.8 18414 (Wow.exe binary)
    SMSG_UI_TIME                                 = 0x0027, // 5.4.8 18414 (reference-consensus)
    CMSG_CHAR_RACE_CHANGE                        = 0x0D24, // not in 5.4.8 (legacy)
    MSG_VIEW_PHASE_SHIFT                         = 0x14FA,
    SMSG_TALENTS_INVOLUNTARILY_RESET             = 0x088A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_DEBUG_SERVER_GEO                        = 0x14FD, // not in 5.4.8 (legacy)
    SMSG_LOOT_UPDATE                             = 0x1863, // 5.4.8 18414 (reference single-source: SkyFire; fuzzy via SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT)
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES            = 0x031C, // 5.4.8 18414 (Wow.exe binary)
    SMSG_ALL_QUESTS_COMPLETED                    = 0x6314, // not in 5.4.8 (legacy)
    SMSG_AFK_MONITOR_INFO_RESPONSE               = 0x1505, // not in 5.4.8 (legacy)
    SMSG_AREA_TRIGGER_NO_CORPSE                  = 0x089E, // 5.4.8 18414 (reference single-source: WPP)
    SMSG_CAMERA_SHAKE                            = 0x0C3A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_SOCKET_GEMS                             = 0x12A6, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_SOCKET_GEMS_RESULT)
    SMSG_CONNECT_TO                              = 0x1149, // 5.4.8 18414 (reference-consensus)
    CMSG_CONNECT_TO_FAILED                       = 0x2533, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_SUSPEND_COMMS                           = 0x1D48, // 5.4.8 18414 (reference-consensus)
    SMSG_RESUME_COMMS                            = 0x0969, // 5.4.8 18414 (reference-consensus)
    CMSG_AUTH_CONTINUED_SESSION                  = 0x0F49, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SEND_ALL_COMBAT_LOG                     = 0x1515, // not in 5.4.8 (legacy)
    SMSG_OPEN_LFG_DUNGEON_FINDER                 = 0x0E8A, // 5.4.8 18414 (reference single-source: SkyFire)
    SMSG_MOVE_SET_COLLISION_HGT                  = 0x0250, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_MOVE_SET_COLLISION_HEIGHT)
    ...
    SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT1      = 0x2126, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT2      = 0x6814, // 4.3.4 15595 — NYI in 5.4.8 refs (unverified)
    SMSG_COMPRESSED_UNKNOWN_1310                 = 0x151F, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1311                            = 0x1520, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1312                            = 0x1521, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1314                            = 0x1523, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1315                            = 0x1524, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1316                            = 0x1525, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1317                            = 0x1526, // not in 5.4.8 (legacy)
    SMSG_UNKNOWN_1329                            = 0x1532, // not in 5.4.8 (legacy)
    SMSG_PLAYER_MOVE                             = 0x1A32, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED       = 0x0B28, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED            = 0x1DAB, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_PITCH_RATE              = 0x0AB3, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED          = 0x1F9F, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_RUN_SPEED               = 0x02F1, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_SWIM_SPEED              = 0x1D8E, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED         = 0x0046, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_TURN_RATE               = 0x0832, // 5.4.8 18414 (reference-consensus)
    SMSG_SPLINE_MOVE_SET_WALK_SPEED              = 0x08B2, // 5.4.8 18414 (reference-consensus)
    CMSG_REORDER_CHARACTERS                      = 0x08A7, // 5.4.8 18414 (Wow.exe binary)
    SMSG_SET_CURRENCY_WEEK_LIMIT                 = 0x0E2A, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_UPDATE_CURRENCY_WEEK_LIMIT)
    ...
    SMSG_RATED_BG_STATS                          = 0x0394, // 5.3.0 — NYI in 5.4.8 refs (unverified)
    CMSG_REQUEST_PVP_REWARDS                     = 0x0375, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PVP_REWARDS                             = 0x08AA, // 5.4.8 18414 (reference-consensus; fuzzy via SMSG_REQUEST_PVP_REWARDS_RESPONSE)
    CMSG_REQUEST_PVP_OPTIONS_ENABLED             = 0x0A22, // 5.4.8 18414 (Wow.exe binary)
    SMSG_PVP_OPTIONS_ENABLED                     = 0x080A, // 5.4.8 18414 (reference-consensus)
    CMSG_REQUEST_HOTFIX                          = 0x158D, // 5.4.8 18414 (Wow.exe binary)
    SMSG_DB_REPLY                                = 0x103B, // 5.4.8 18414 (reference-consensus)
    CMSG_OBJECT_UPDATE_FAILED                    = 0x1061, // 5.4.8 18414 (Wow.exe binary)
    CMSG_REFORGE_ITEM                            = 0x0C4F, // 5.4.8 18414 (Wow.exe binary)
    SMSG_REFORGE_RESULT                          = 0x141E, // 5.4.8 18414 (reference-consensus)
    CMSG_LOAD_SCREEN                             = 0x1DBD, // 5.4.8 18414 (Wow.exe binary)
    SMSG_START_TIMER                             = 0x0E3F, // 5.4.8 18414 (reference-consensus)
    ...
    SMSG_ARENA_UNIT_DESTROYED                    = 0x000F, // 5.4.8 18414 (reference single-source: Pandaria)
    ...
    SMSG_MULTIPLE_PACKETS                        = 0x1168, // 5.4.8 18414 — NYI in 5.4.8 refs (unverified)
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT          = 0x0332, // 5.4.8 18414 (reference single-source: Pandaria)
    ...
    SMSG_SET_TIME_ZONE_INFORMATION               = 0x19C1, // 5.4.8 18414 (reference-consensus)
};
