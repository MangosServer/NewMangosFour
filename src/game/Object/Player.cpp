...
uint32 Player::GetResurrectionSpellId()
{
    ...
    for (AuraList::const_iterator itr = dummyAuras.begin(); itr != dummyAuras.end(); ++itr)
    {
        ...
        // Check based on spell ID instead of proto members which have been refactored
        if (prio < 2)
        {
            switch ((*itr)->GetId())
            {
                case 20707: spell_id =  3026; prio = 3; break;        // rank 1
                case 20762: spell_id = 20758; prio = 3; break;        // rank 2
                case 20763: spell_id = 20759; prio = 3; break;        // rank 3
                case 20764: spell_id = 20760; prio = 3; break;        // rank 4
                case 20765: spell_id = 20761; prio = 3; break;        // rank 5
                case 27239: spell_id = 27240; prio = 3; break;        // rank 6
                case 47883: spell_id = 47882; prio = 3; break;        // rank 7
                default:
                    continue;
            }
        }
