...
enum QuestShareMessages
{
    ...
    QUEST_PARTY_MSG_DEAD                    = 5,            // ERR_QUEST_PUSH_DEAD_S
    ...
    QUEST_PARTY_MSG_CANT_BE_SHARED_TODAY    = 9,            // ERR_QUEST_PUSH_NOT_DAILY_S
    QUEST_PARTY_MSG_SHARING_TIMER_EXPIRED   = 10,           // ERR_QUEST_PUSH_TIMER_EXPIRED_S
    QUEST_PARTY_MSG_NOT_IN_PARTY            = 11,           // ERR_QUEST_PUSH_NOT_IN_PARTY_S
    QUEST_PARTY_MSG_DIFFERENT_SERVER_DAILY  = 12,           // ERR_QUEST_PUSH_DIFFERENT_SERVER_DAILY_S
    QUESY_PARTY_MSG_DIFFERENT_SERVER_DAILY  = QUEST_PARTY_MSG_DIFFERENT_SERVER_DAILY,
    QUEST_PARTY_MSG_NOT_ALLOWED             = 13            // ERR_QUEST_PUSH_NOT_ALLOWED_S
};
